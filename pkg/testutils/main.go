...
//
//nolint:cyclop
func SetupMockEnvironment(tb testing.TB, ctx context.Context, conf config.Config) (config.Config, *openvpn.Client, net.Listener, *oauth2.Provider, *httptest.Server, *http.Client, *Logger, func()) {
	tb.Helper()
