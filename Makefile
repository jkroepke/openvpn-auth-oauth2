...
fmt:
	...
	@-go run golang.org/x/tools/cmd/goimports@v0.31.0 -l -w .
	@-go run github.com/bombsimon/wsl/v4/cmd/wsl@v4.6.0 -fix ./...
	@-go run github.com/catenacyber/perfsprint@v0.9.1 --fix ./...
	@-go run github.com/tetafro/godot/cmd/godot@v1.4.20 -w .
	@-go run github.com/4meepo/tagalign/cmd/tagalign@v1.4.2 -fix -sort -order "json,koanf" ./...
	@-go run github.com/golangci/golangci-lint/cmd/golangci-lint@v2.0.1 run ./...
