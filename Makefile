...
fmt:
	...
	@-go run golang.org/x/tools/cmd/goimports@v0.33.0 -l -w .
	...
	@-go run golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.33.0 -test=false -fix ./...
