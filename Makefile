...
fmt:
	...
	@-go run golang.org/x/tools/cmd/goimports@v0.34.0 -l -w .
	@-go run github.com/bombsimon/wsl/v4/cmd/wsl@v4.7.0 -fix ./...
	@-go run github.com/catenacyber/perfsprint@v0.9.1 --fix ./...
	@-go run github.com/tetafro/godot/cmd/godot@v1.4.20 -w .
	@-go run github.com/4meepo/tagalign/cmd/tagalign@v1.4.2 -fix -sort ./...
	@-go run golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.34.0 -test=false -fix ./...
