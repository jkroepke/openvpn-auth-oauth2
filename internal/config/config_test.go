...
func TestValidate(t *testing.T) {
	for _, tt := range []struct {
		...
		{"", Config{Http: &Http{BaseUrl: &url.URL{Scheme: "http", Host: "invalid"}, Secret: "invalid"}, Oauth2: &OAuth2{Issuer: &url.URL{Scheme: "http", Host: "invalid"}, Client: &OAuth2Client{Id: "client"}, Endpoints: &OAuth2Endpoints{}, Validate: &OAuth2Validate{}}, OpenVpn: &OpenVpn{Bypass: &OpenVpnBypass{}}, Log: &Log{}}, "http.check is nil"},
		...
		{"", Config{Http: &Http{BaseUrl: &url.URL{Scheme: "http", Host: "invalid"}, Secret: "0123456789101112", Check: &HttpCheck{}}, Oauth2: &OAuth2{Issuer: &url.URL{Scheme: "http", Host: "invalid"}, Client: &OAuth2Client{Id: "client"}, Endpoints: &OAuth2Endpoints{}, Validate: &OAuth2Validate{}}, OpenVpn: &OpenVpn{Addr: &url.URL{Scheme: "tcp", Host: "127.0.0.1:9000"}, Bypass: &OpenVpnBypass{}}, Log: &Log{}}, ""},
		{"", Config{Http: &Http{BaseUrl: &url.URL{Scheme: "http", Host: "invalid"}, Secret: "0123456789101112", Check: &HttpCheck{}}, Oauth2: &OAuth2{Issuer: &url.URL{Scheme: "http", Host: "invalid"}, Client: &OAuth2Client{Id: "client"}, Endpoints: &OAuth2Endpoints{Token: &url.URL{}}, Validate: &OAuth2Validate{}}, OpenVpn: &OpenVpn{Addr: &url.URL{Scheme: "tcp", Host: "127.0.0.1:9000"}, Bypass: &OpenVpnBypass{}}, Log: &Log{}}, ""},
