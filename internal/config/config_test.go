...
func TestValidate(t *testing.T) {
	for _, tt := range []struct {
		...
		{"", &Config{Http: &Http{BaseUrl: "invalid", Secret: "0123456789101112"}, Oauth2: &OAuth2{Issuer: "invalid", Client: &OAuth2Client{Id: "client"}, Endpoints: &OAuth2Endpoints{}, Validate: &OAuth2Validate{}}, OpenVpn: &OpenVpn{Addr: "://-", Bypass: &OpenVpnBypass{}}, Log: &Log{}}, "openvpn.addr: invalid URL. error: parse \"://-\": missing protocol scheme"},
		{"", &Config{Http: &Http{BaseUrl: "invalid", Secret: "0123456789101112"}, Oauth2: &OAuth2{Issuer: "invalid", Client: &OAuth2Client{Id: "client"}, Endpoints: &OAuth2Endpoints{}, Validate: &OAuth2Validate{}}, OpenVpn: &OpenVpn{Addr: "tcp://127.0.0.1:9000", Bypass: &OpenVpnBypass{}}, Log: &Log{}}, "-"},
