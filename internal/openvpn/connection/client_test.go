...
func TestNewClientConnection(t *testing.T) {
	...
	for _, tt := range []struct {
	...
	}{
		{
			...
			connection.Client{
				Cid: 0, Kid: 1, Reason: "CONNECT", CommonName: "common_name", IPAddr: "127.0.0.1", IvSSO: "webauth",
			},
			"",
		},
		{
			...
			connection.Client{
				Cid: 0, Kid: 1, Reason: "CONNECT", CommonName: "common_name", IPAddr: "::1", IvSSO: "webauth",
			},
			"",
		},
		{
